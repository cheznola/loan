      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3 px-1">
        ...
        <div className="flex gap-4 sm:gap-6">
          <div className="text-right">
            <div className="text-emerald-400 text-lg font-bold">{stats.futurs.toLocaleString()}</div>
            <div className="text-zinc-500 text-[10px] uppercase tracking-wide">Futurs révélés</div>
          </div>
          <div className="text-right">
            <div className="text-emerald-400 text-lg font-bold">{stats.overthinking.toLocaleString()}h</div>
            <div className="text-zinc-500 text-[10px] uppercase tracking-wide">Overthinking évité</div>
          </div>
        </div>
      </div>
