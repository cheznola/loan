    ...
    <div className="flex flex-col items-center min-h-screen px-4 py-12">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex gap-3 mb-8">
          {/* WhatsApp — deep link natif */}
          
            href={`https://wa.me/?text=${encodeURIComponent(prediction.slackText)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] hover:bg-[#25D366]/20 transition"
          >
          ...
          {/* Slack — copier dans le presse-papier */}
          <button
            onClick={() => copyToClipboard(prediction.slackText, "slack")}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#4A154B]/10 border border-[#4A154B]/30 text-[#E01E5A] hover:bg-[#4A154B]/20 transition cursor-pointer"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-6 border-t border-zinc-800/50 text-center">
          <p className="text-zinc-600 text-sm">
            Créé par{" "}
              ...
              href="https://linkedin.com/in/emmanueldimarco"
              target="_blank"
              rel="noopener noreferrer"
